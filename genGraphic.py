...
def taylor(x):
	return -0.261884*(x-1)**0+-54.745*(x-1)**1+-269.947/2*(x-1)**2+94460.6/6*(x-1)**3+1.37788e+06/24*(x-1)**4+-1.77324e+08/120*(x-1)**5+-5.97903e+09/720*(x-1)**6+2.80095e+11/5040*(x-1)**7
def y_prime(x):
