...
static operation_t operations[]{
    {"+",       ADD,      addH,     addDiff,     2, 2, "\\plus"  , "operator.add"      , false , false },
    {"-",       SUB,      subH,     subDiff,     2, 2, "\\minus" , "operator.sub"      , false , false },
    {"*",       MULTIPLY, mulH,     mulDiff,     2, 1, "\\mul"   , "operator.mul"      , false , false },
    {"/",       DIVIDE,   divH,     divDiff,     2, 1, "\\frac"  , "operator.truediv"  , true  , false },
    {"^",       POW,      powH,     powDiff,     2, 0, "\\pow"   , "operator.pow"      , false , false },
    {"sin",     SIN,      sinH,     sinDiff,     1, 1, "\\sin"   , "math.sin"                  , true  , true  },
    {"cos",     COS,      cosH,     cosDiff,     1, 1, "\\cos"   , "math.cos"                  , true  , true  },
